export const name = "Chicken Parmesian";
	...
	return (
		<div>
			...
			<p>
				...
				! estimated price per meal is around $3.50. if you want to contribute to me doing this more, there is
			...
			<ul>
				...
				<li>olive oil/avacado oil (we used both)</li>
